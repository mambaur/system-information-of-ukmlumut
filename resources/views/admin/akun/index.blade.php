            ...
            <div class="row">
                ...
                <form>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="feFirstName" placeholder="First Name" value="{{\Auth::user()->name}}" required> </div>
                    <div class="form-group col-md-6">
                        <label for="feLastName">Nama Belakang</label>
                        <input type="text" class="form-control" id="feLastName" placeholder="Last Name" value="{{\Auth::user()->nama_belakang}}"> </div>
                    </div>
                    <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="feEmailAddress">Email</label>
                        <input type="email" class="form-control" id="feEmailAddress" placeholder="Email" value="{{\Auth::user()->email}}" required> </div>
                    <div class="form-group col-md-6">
