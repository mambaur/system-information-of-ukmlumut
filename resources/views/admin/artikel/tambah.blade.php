            ...
            <div class="card card-small mb-3">
              <div class="card-body">
                <div class="add-new-post">
                  <input class="form-control form-control-lg mb-3" name="judul" type="text" placeholder="Judul">
              ...
              <div class='card-body p-0'>
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex px-3">
                    <button class="btn btn-sm btn-outline-accent" name="draft" type="submit">
                      <i class="material-icons">save</i> Save Draft</button>
                    <button class="btn btn-sm btn-accent ml-auto" name="publish" type="submit">
