...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>Cetak data informasi organisasi</title>
    ...
    <div class="container my-5">
        ...
        <div class="cetak" id="cetak">
            <div class="text-center font-weight-bold mb-5">
                <h3 class="text-dark">DAFTAR INFORMASI ORGANISASI</h3>
            </div>
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:15%">{{$item->nama_organisasi}}</td>
                        <td>{{$item->nama_pengurus}} {{$item->jabatan ? ' ('.$item->jabatan.')':''}}</td>
