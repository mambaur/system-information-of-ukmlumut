                        ...
                        <div class="col-lg-4 ">
                            <div class="test-inner p-0">
                                <div class="test-author-thumb d-flex">
                                    <img style="object-position: center;object-fit: cover;width: 90px; height: 90px" src="/assets/admin/images/akun/{{$item->image}}" alt="Testimonial author" class="img-fluid">
